...
#define AI_NETWORK_MODEL_SIGNATURE     "8c09302588f379007095fb0899f42498"
...
#define AI_TOOLS_DATE_TIME   "Sun Mar 29 20:31:17 2020"
...
AI_STATIC ai_array dense_nl_output_array;   /* Array #10 */
...
AI_STATIC ai_tensor dense_nl_output;   /* Tensor #11 */
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0x0, 0x0, AI_SHAPE_INIT(4, 1, 32, 26, 2), AI_STRIDE_INIT(4, 4, 4, 128, 3328),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0x0, 0x0, AI_SHAPE_INIT(4, 100, 10, 1, 1), AI_STRIDE_INIT(4, 4, 400, 4000, 4000),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0x0, 0x0, AI_SHAPE_INIT(4, 5408, 100, 1, 1), AI_STRIDE_INIT(4, 1, 2704, 270400, 270400),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0x0, 0x0, AI_SHAPE_INIT(4, 1, 32, 13, 13), AI_STRIDE_INIT(4, 4, 4, 128, 1664),
  1, &conv2d_output_array, NULL)
AI_TENSOR_OBJ_DECLARE(
  conv2d_output0, AI_STATIC,
  0x0, 0x0, AI_SHAPE_INIT(4, 1, 5408, 1, 1), AI_STRIDE_INIT(4, 4, 4, 21632, 21632),
  1, &conv2d_output_array, NULL)
AI_TENSOR_OBJ_DECLARE(
  ...
  ai_network* net_ctx, const ai_buffer* activation_buffer)
{
...

  {
    ...
    conv2d_output_array.data = AI_PTR(activations + 6656);
    conv2d_output_array.data_start = AI_PTR(activations + 6656);
    ...
    dense_1_output_array.data = AI_PTR(activations + 400);
    dense_1_output_array.data_start = AI_PTR(activations + 400);
  ...
  ai_network* net_ctx, const ai_buffer* weights_buffer)
{
...

  {
    ...
    dense_1_bias_array.data = AI_PTR(weights + 276144);
    dense_1_bias_array.data_start = AI_PTR(weights + 276144);
    dense_1_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_1_weights_array.data = AI_PTR(weights + 272144);
    dense_1_weights_array.data_start = AI_PTR(weights + 272144);
    dense_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_bias_array.data = AI_PTR(weights + 271744);
    dense_bias_array.data_start = AI_PTR(weights + 271744);
